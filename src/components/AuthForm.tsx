    ...
    <div className="w-full max-w-sm mx-auto px-4 py-12">
      ...
      <div className="bg-slate-800 rounded-2xl p-6">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 px-4 bg-white text-slate-900 rounded-xl font-semibold flex items-center justify-center gap-3 hover:bg-slate-100 transition-colors disabled:opacity-50"
        >
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 rounded-xl font-semibold transition-colors disabled:opacity-50"
          >
